...
def process_last_500_matches(mode: str = '4on4') -> bool:
...
def process_match(ktx_json: str, mode: str) -> list[PlayerMatchRanking]:
    ...
    # create match info
    match_info: MatchInfo = __create_match_info(parsed_json, mode)
...
def __create_match_info(match_dict: dict[str, any], mode: str) -> MatchInfo:
